...
LABEL repository="https://github.com/benwebdev/firebase-action"
LABEL homepage="https://github.com/benwebdev/firebase-action"
LABEL maintainer="Ben Line <benwebdev@github.com>"
